...
export const ProjectList = [
  {
    ...
    description: "This app takes the user's date of birth and gives them a countdown of days, hours, minutes and even seconds to their birthday."
...

  {
    ...
    description: "This app allows the user to type a message and then have it encrypted. The message will be saved on a database along with it's key. The message can then be decrypted in the dashboard."
...

  {
    ...
    image: Project3,
    skills: "React, Javascript, HTML, CSS, Redux, Express, Mongoose, MongoDB",
    description: "This app allows the user to create an account and play tic-tac-toe. Their score and other data will be saved and display in the dashboard."
  ...
  },
  {
    ...
    description: "This app displays movies that are searched by the user and then allows the user to save them to a favorites list saved to localStorage."
